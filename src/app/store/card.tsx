...
export default function Card({ color, img, currency, pay, price, id }: Props) {
  const rgba = convertHexToRgba({ hexColor: color, opacity: 100 });
  const rgbao = convertHexToRgba({ hexColor: color, opacity: 50 });
  return (
    <div className="flex justify-center w-full">
      <div className="relative h-[324px] w-[204px] bg-white shadow-sm rounded-md overflow-hidden">
